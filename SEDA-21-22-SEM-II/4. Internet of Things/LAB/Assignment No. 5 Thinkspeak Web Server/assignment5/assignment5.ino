...
WiFiClient client;
long myChannelNumber = 1715622;
const char myWriteAPIKey[] = "QDULOD8O4YKIDYLF";
...
Serial.begin(9600);
WiFi.begin("realme C25","QWERTYOP");
...
tempf=(vout*1.8)+32; // Converting to Fahrenheit 
  ...
  ThingSpeak.writeField(myChannelNumber, 1, tempf, myWriteAPIKey);
  delay(2000);
}
